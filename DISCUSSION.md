I've laid the foundation to implement some powerful features

- data cleaning and normalization
- infinite scrolling with server side pagination
- frontend updates to fix basic anti-patterns and 
- UI design updates for better UX and brand identity
- extended the pagination endpoint to filter on the fly
...
This was a fun hackathon style project btw `:)`